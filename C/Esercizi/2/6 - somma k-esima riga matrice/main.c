 ...
 * restituisce come parametro di output la somma degli elementi della k-sima riga.
 */
...
/*
 ...
 =======================================================================================================================
 */
int calcola(int mm[][MAX], int m, int k)
{
	/*~~~~~~~~~~~~~~*/
	int risultato = 0;
	/*~~~~~~~~~~~~~~*/

	for(int j = 0; j < m; j++) risultato += mm[k][j];
...
int main()
{
	...
	printf("la somma degli elementi della k-esima riga e': %d\n", ris);
